      ...
      <div className="container">
        <header className={isScrolled ? 'scrolled' : ''}>
          <nav aria-label="Main navigation">
            ...
            {/* Two-row button stack in upper right */}
            <div className="nav-buttons-stack">
              {/* Top row: Utility buttons with icons - disappears on scroll */}
              <div className={`nav-utility-row ${isScrolled ? 'hidden' : ''}`}>
              ...
              {/* Bottom row: Primary buttons - shrinks on scroll */}
